...
<?php
echo MyWriteMidSection("MY SETUP COACH", "Reach To Your Coach For A Hand Up", 
"Your Setup Coach will help you through the Setup Steps.", 
...
<?php $coach_id = $mrow_coaches['coach_id_setup']; ?>
