...
//document.writeln('<input name="shipping_state" class="elInput required0 garlic-auto-save" data-type="extra" type="hidden" value="&t=' + t + '" readonly="">');
//document.getElementById('cf_contact_shipping_city').value = "?da=" + da;
//document.getElementById('cf_contact_shipping_state').value = "&t=" + t;
if (da) {
	document.getElementById("da_aff").innerHTML = "Referral: " + da;
} else {
	document.getElementById("da_aff").innerHTML = "No Referral";	
}