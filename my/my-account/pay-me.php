...
if (isset($_POST['submit'])) {
	...
	if($_POST['pay_by']=='ACH'){
		if($check_row['pay_type']!='ACH'){
			$error[] ='Invalid: Please <a href="/my-account/pay-me-ach.php">add your Direct Deposit details</a> before selecting as your payment method.';
		}
	}elseif($pay_by=='Wire'){
		if($wire_row['pay_type']!='Wire'){
			$error[] ='Invalid: Please <a href="/my-account/pay-me-wires.php">add your Wire details</a> before selecting as your payment method.';
		}
...
<? } ?>
            ...
            <tr>
              ...
              <td><select name='pay_out_min'>
				<?=WriteSelect($mrow['pay_out_min'], array(
					array(100=>'$100')
					, array(250=>'$250')
					, array(500=>'$500')
					, array(1000=>'$1000')
					, array(2500=>'$2500')
					, array(5000=>'$5000')
					, array(1000000=>'$1000000')), true, false)?>
              </select></td>
            </tr>
            <tr>
              <td align="right"><nobr>Tax Certification:</nobr></td>
              <td><?php echo ($mrow['tax_id']) ? "<font color=green>Provided</font>" : "<font color=red>Required</font>";?>
			  &nbsp; &nbsp; <a href="/my-account/pay-me-tax.php">Edit</a></td>
            </tr>
<?php /*            <tr>
...
<div id="tabs-check">
<h4>US: Checks ($3.50 fee per payment)</h4>
<table width="100%" border="0" cellpadding="4" cellspacing="0">
           <tr>
              <td align="right" width="200px">Make Checks Out To:</td>
              <td align="left">
...
<div id="tabs-ach">
<h4>US: Direct Deposits ($2.5 fee per payment)</h4>
<?php /*
<p><b>Part 1</b></p>
<div style="display:block;margin:0;padding:0;border:0;outline:0;font-size:10px!important;color:#AAA!important;vertical-align:baseline;background:transparent;width:706px;"><iframe frameborder="0" height="500" scrolling="no" src="https://rightsignature.com/forms/DirectDEPAuthdocx-86c42a/embedded/d79daa96261?height=500" width="706"></iframe><div style="font-family: 'Lucida Grande', Helvetica, Arial, Verdana, sans-serif;line-height:13px !important;text-align:center;margin-top: 6px !important;"><a href="https://rightsignature.com" target="_blank" style="color:#AAA;text-decoration:none;">eSignature</a> by RightSignature &copy; &nbsp;&bull;&nbsp; <a href="https://rightsignature.com/terms" target="_blank" style="color:#888;">Terms of Service</a> &nbsp;&bull;&nbsp; <a href="https://rightsignature.com/privacy" target="_blank" style="color:#888;">Privacy Policy</a></div></div>
...
<? if(isset($ach_row)){?>
	...
	<tr>
	  <td align="right">&nbsp;</td>
	  <td align="left">[ <a href="/my-account/pay-me-ach.php">Edit your Direct Deposit Details</a> ]</td>
	  </tr>
<? } else { ?>
	<tr>
	  <td colspan="2" align="left"><a href="/my-account/pay-me-ach.php">+ Add your Direct Deposit Details</a></td>
	  </tr>
<? } ?>
</table>
...
<? if($wire_row){?>
	...
	<tr>
	  <td align="right">&nbsp;</td>
	  <td align="left">[ <a href="/my-account/pay-me-wires.php">Edit your Wire Details</a> ]</td>
	  </tr>
<? } else { ?>
	<tr>
	  <td colspan="2" align="left"><a href="/my-account/pay-me-wires.php">+ Add your Wire Details</a></td>
	  </tr>
<? } ?>
</table>
</div>
