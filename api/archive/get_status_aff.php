...
<?
echo _GetAffStatusTable($db, $member_id);


function _GetAffStatusTable($db, $member_id) {
	...
	. WriteTH("#")	
	. WriteTH("Affiliate Status")
	. WriteTH("Start Date")	
	. WriteTH("End Date")	
	. "</tr></thead>";
	$table_foot = "</table>";
	if (!$table_rows) {
		$res = "<i><font color=red>You have no history of being an Active Affiliate.</font></i>";
	} else {
