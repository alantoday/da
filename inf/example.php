<?php
// USAGE: http://www.digialti.com/da/scripts/Infusionsoft/examples/list_objects.php?object=Contact

/**
 * @var Infusionsoft_Generated_Base $object
 */
include('../scripts/Infusionsoft/infusionsoft.php');
	include('../scripts/Infusionsoft/object_editor_all_tables.php');
	include('../scripts/Infusionsoft/tests/testUtils.php');
	?>
<form>
    Table:<br/>
    <select name="object">
